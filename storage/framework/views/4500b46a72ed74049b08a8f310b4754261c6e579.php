              ...
              <section class="col-md-6 my-5">
                <center><div class="card shadow p-5 pad">
                  ...
                  <form>
                    ...
                    <button type="submit" class="btn btn-danger btn-block mt-3 rounded-pill" onclick="alert('Вітаємо, тепер розсилка буде приходити Вам на пошту!')">Subscribe</button>
                </div></center>
              </section>
            </div>
        </section>
...
</html><?php /**PATH D:\OSPanel\domains\serverODZ\resources\views/home.blade.php ENDPATH**/ ?>