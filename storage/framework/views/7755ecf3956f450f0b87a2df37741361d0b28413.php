...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('css/catalogues.css')); ?>" rel="stylesheet">
        <script src="<?php echo e(asset('js/file.js')); ?>"></script>
        <script src="<?php echo e(asset('js/catalogues.js')); ?>"></script>
...
</html><?php /**PATH D:\OSPanel\domains\serverODZ\resources\views/catalogues.blade.php ENDPATH**/ ?>